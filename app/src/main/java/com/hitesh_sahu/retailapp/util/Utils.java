...
import com.hitesh_sahu.retailapp.view.fragment.HistoryFragment;
import com.hitesh_sahu.retailapp.view.fragment.HomeFragment;
import com.hitesh_sahu.retailapp.view.fragment.InfoFragment;
...
import com.hitesh_sahu.retailapp.view.fragment.SaldoFragment;
...
public class Utils {
	...
	public static final String SALDO_FRAGMENT = "Saldo";
	...
	public static void switchContent(int id, String TAG,
		...
		if (CURRENT_TAG == null || !TAG.equals(CURRENT_TAG)) {
			...
			if (fragment == null) {
				...
				else if (TAG.equals(INFO_FRAGMENT)) {
					fragmentToReplace = new InfoFragment();
				}
				else if (TAG.equals(SALDO_FRAGMENT)) {
					fragmentToReplace = new SaldoFragment();
				}
				else if (TAG.equals(HISTORY_FRAGMENT)) {
					fragmentToReplace = new HistoryFragment();				}
			} else

			{
				if (TAG.equals(HOME_FRAGMENT)) {
					...
					fragmentToReplace = (InfoFragment) fragment;
				}else if (TAG.equals(SALDO_FRAGMENT)) {
					fragmentToReplace = (SaldoFragment) fragment;
				}
				else if (TAG.equals(HISTORY_FRAGMENT)) {
